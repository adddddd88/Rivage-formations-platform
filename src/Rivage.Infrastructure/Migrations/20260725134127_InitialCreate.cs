        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainerProfileId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Formations_TrainerProfiles_TrainerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormationTitle = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExerciseResponse = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScorePercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAttemptAnswers_AnswerOptions_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Formations_TrainerProfileId",
                table: "Formations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Modules_FormationId_OrderIndex",
                table: "Modules",
